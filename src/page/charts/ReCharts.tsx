...
import PieRechart from "../../components/charts/rechart/component/PieRechart"
...
const ReCharts = () => {
    return(
        <Box>
            <Box mb={26}>
                <a href="https://github.com/recharts/recharts" className="h5" target={"_blank"}>Recharts</a>
                <Text varient="body2" weight="medium" secondary paragraph>Redfined chart library built with React & D3</Text>
            </Box>
            <GridInnerContainer spacing={1.6}>
                ...
                <GridItem xs={12}>
                    <Card padding="1.4rem 1.2rem">
                        <ChartTitle title="Commercial network & enterprises" subtitle="Line chart" />
                    <LineRechart />
                    </Card>
                </GridItem>
                <GridItem xs={12}>
