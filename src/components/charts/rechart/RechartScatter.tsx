...
const RechartScatter = () => {
    const {data, loading} = useFetch<any[]>('/api/chart-data/rechart/frameworkUsage');
  ...
  return (
    ...
    <ScatterChart data={data} margin={{left: -20}}> 
        ...
        <Legend verticalAlign='top' align='left' content={<CustomLegend style={{marginLeft: 24}} />} height={50} />
